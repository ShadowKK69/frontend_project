  ...
  return (
    <div className="home-wrapper">
      ...
      <main className="home-content">
        ...
        <h2 className="home-description">I enjoy creating products from scratch and improve existing ones. <br></br>In simple terms, I create websites that make a profit or enhance business.</h2>
